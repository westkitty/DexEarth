...
export const DATASETS = {
  flights: {
    id: 'flights',
    name: 'airplanes.live regional aggregate',
    remoteUrl: '/proxy/flights',
    format: 'json',
    cacheTtlMs: 30000,
  },
  // ── Global Overlays ──
  ne_110m_countries: {
    ...
    category: 'geometry',
    bundledUrl: '/data/borders/ne_110m_admin_0_countries.geojson',
    format: 'geojson',
  ...
  ne_50m_countries: {
    ...
    category: 'geometry',
    bundledUrl: '/data/borders/ne_50m_admin_0_countries.geojson',
    format: 'geojson',
    cacheTtlMs: Infinity,
    sizeEstimate: '2.5 MB',
  ...
  tle_data: {
    ...
    category: 'telemetry',
    remoteUrl: '/proxy/tle',
    bundledUrl: '/data/tle/starter.tle',
    fallbackUrls: ['https://celestrak.org/NORAD/elements/gp.php?GROUP=visual&FORMAT=tle'],
    format: 'text/tle',
  ...
  usgs_earthquakes_1mo: {
    ...
    name: 'USGS: Earthquakes (all, 24h)',
    category: 'events',
    remoteUrl: 'https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson',
    fallbackUrls: ['https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_day.geojson'],
    format: 'geojson',
  ...
  submarine_cables: {
    ...
    fallbackUrls: ['https://www.submarinecablemap.com/api/v3/cable/cable-geo.json'],
    format: 'geojson',
