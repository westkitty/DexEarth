...
const TOUR_STEPS = [
  {
    ...
    title: 'DATA LAYERS',
    content:
      'Toggle massive datasets on and off. Switch between borders, thermal anomalies, satellite propagation, and more.',
  },
  {
    targetId: 'tour-tab-time',
    title: 'TIME & ORBIT',
    content:
      'Control the simulation clock. Fast-forward through orbital paths or view the solar terminator at any point in the future.',
  },
  {
  ...
  },
  {
    ...
    title: 'VIEWS',
    content:
      'Save and manage scenario snapshots. Export offline views for later tactical reconstruction.',
  },
  {
  ...
  },
  {
    ...
    title: 'THREAT INDEX',
    content:
      'Algorithmic threat analysis overlay. Evaluates current geography against threat heuristics.',
  },
  {
  ...
  },
  {
    ...
    title: 'AUDIT LOG',
    content:
      'Rolling system audit log tracking layer toggles, errors, UI actions, and performance events.',
  },
  {
  ...
  },
  {
    ...
    title: 'RENDER STYLES',
    content:
      'Swap between realistic visualization, thermal imaging, and tactical wireframe modes instantly.',
  },
  {
    targetId: 'tour-drag-handle',
    title: 'CUSTOMIZE HUD',
    content:
      'The entire navigation bar is free-floating. Click and drag this handle to move the menu anywhere on your screen. The dropdown panels will automatically orient upwards or downwards depending on where you place it.',
  },
  {
    targetId: 'tour-target-warp-home', // We will inject this ID into WarpHome or PhaseIIRoot
    title: 'WARP HOME',
    content:
      'Clicking this persistent button will instantly cancel your active tool, close open panes, and fly the camera back to base.',
  },
]
  ...
  return (
    ...
    >
      ...
      >
        {stepIndex === -1 ? (
          <>
            <h2 style={{ color: '#00FF9F', marginTop: 0, fontSize: '18px', letterSpacing: '2px' }}>
              WELCOME TO DEXEARTH
            </h2>
