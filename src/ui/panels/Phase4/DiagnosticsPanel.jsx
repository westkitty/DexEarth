  ...
  return (
    <Panel>
      <CollapsibleSection
        ...
        color={UI_TOKENS.warning}
        defaultOpen={false}
      >
        {/* Datasets */}
        <div style={{ marginBottom: '12px' }}>
          <div style={{ fontSize: '10px', color: UI_TOKENS.textSecondary, marginBottom: '6px' }}>
            Dataset Resolution
          </div>
          {loading ? (
            <div style={{ fontSize: '9px', color: UI_TOKENS.textMuted }}>
              Running diagnostics...
            </div>
          ) : (
        ...
        <div>
          ...
          >
            ...
            <span>
              {auditReport.bound} / {auditReport.total}
            </span>
          </div>
          {auditReport.unbound > 0 ? (
            ...
            >
              <div style={{ fontSize: '8px', color: '#ff4444', textTransform: 'uppercase' }}>
                Missing Handlers:
              </div>
            ...
            <div style={{ fontSize: '9px', color: UI_TOKENS.success }}>
              All registered UI controls are firmly bound.
            </div>
          )}
        </div>
      </CollapsibleSection>
