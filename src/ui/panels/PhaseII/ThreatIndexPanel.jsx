    ...
    <div style={{ ...S.panel, position: 'relative' }}>
      ...
      <div style={S.row}>
        <button
          style={{
            ...S.btn,
            ...(isActive ? { background: '#FF220022', border: '1px solid #FF2200' } : {}),
          }}
        ...
        {isActive && (
          <button style={S.btn} onClick={() => _recompute(weights)}>
            ↺ Recompute
          </button>
        )}
      </div>
            ...
            {Object.keys(PRESET_WEIGHTS).map(name => (
              <button
                ...
                style={{
                  ...S.btn,
                  ...(preset === name
                    ? { background: '#FF220022', border: '1px solid #FF2200' }
                    : {}),
                }}
