      ...
      <div style={S.row}>
        {events.map(ev => (
          <button
            ...
            style={{
              ...S.btn,
              ...(isActive(ev.id) ? { background: '#FF00FF22', border: '1px solid #FF00FF' } : {}),
            }}
            onClick={() =>
              isActive(ev.id) ? cascadeModel.cancelEvent(ev.id) : cascadeModel.triggerEvent(ev.id)
            }
          >
        ...
        {state.activeEvents.length > 0 && (
          <button
            style={{ ...S.btn, color: '#FF4444', border: '1px solid #FF444455' }}
            onClick={() => cascadeModel.reset()}
          >
            Reset All
          </button>
        )}
          ...
          {state.causalChains.map((c, i) => (
            <div
              ...
              style={{
                ...
                color: '#FF88FF',
                marginBottom: '3px',
                borderBottom: '1px solid #FF00FF11',
                paddingBottom: '2px',
              }}
            >
